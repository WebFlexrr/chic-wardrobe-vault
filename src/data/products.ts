...
export const categories: Category[] = [
  {
    ...
    image: '/assets/categories/dress.jpg',
    
    
    
    featuredImage: '/assets/categories/dress.jpg',
    subcategories: [
      { id: '101', name: 'Office Wear', slug: 'office-wear', categoryId: '1', image: '/assets/subcategories/office-wear.webp' },
      { id: '102', name: 'Casual', slug: 'casual', categoryId: '1', image: '/assets/subcategories/casual.webp' },
      { id: '103', name: 'Party Wear', slug: 'party-wear', categoryId: '1', image: '/assets/subcategories/party-wear.webp' },
    ]
  },
  {
    id: '2',
    ...
    featuredImage: '/assets/categories/top.jpg',
    subcategories: [
  ...
  },
  {
    ...
    image: '/assets/categories/bottom.webp',
    featuredImage: '/assets/categories/bottom.webp',
    subcategories: [
  ...
  },
  {
    ...
    featuredImage: '/assets/categories/outerwear.jpg',
    subcategories: [
...
export const products: Product[] = [
  {
    ...
    images: ['/assets/products/dress-1-1.webp', '/assets/products/dress-1-2.webp', '/assets/products/dress-1-3.webp'],
    category: 'Dresses',
  ...
  },
  {
    ...
    images: ['/assets/products/dress-2-1.webp', '/assets/products/dress-2-2.webp', '/assets/products/dress-2-3.webp'],
    category: 'Dresses',
    subcategory: 'Office Wear',
  ...
  },
  {
    ...
    images: ['/assets/products/dress-3-1.webp', '/assets/products/dress-3-2.webp', '/assets/products/dress-3-3.webp'],
    category: 'Dresses',
    subcategory: 'Casual',
  ...
  },
  {
    ...
    images: ['/assets/products/dress-4-1.webp', '/assets/products/dress-4-2.webp', '/assets/products/dress-4-3.webp'],
    category: 'Dresses',
    subcategory: 'Office Wear',
  ...
  },
  {
    ...
    images: ['/assets/products/dress-5-1.webp', '/assets/products/dress-5-2.webp', '/assets/products/dress-5-3.webp'],
    category: 'Dresses',
  ...
  },
  {
    ...
    images: ['/assets/products/top-1-1.webp', '/assets/products/top-1-2.webp', '/assets/products/top-1-3.webp'],
    category: 'Tops',
    subcategory: 'Blouses',
  ...
  },
  {
    ...
    images: ['/assets/products/bottom-1-1.webp', '/assets/products/bottom-1-2.webp', '/assets/products/bottom-1-3.webp'],
    category: 'Bottoms',
    subcategory: 'Pants',
  ...
  },
  {
    ...
    images: ['/assets/products/outerwear-1-1.webp', '/assets/products/outerwear-1-2.webp', '/assets/products/outerwear-1-3.webp'],
    category: 'Outerwear',
    subcategory: 'Blazers',
